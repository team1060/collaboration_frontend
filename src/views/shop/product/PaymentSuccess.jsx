...
import {
  ...
  postPaymentOptions,
  postShipping,
} from "../../../core/util/http/shop/apiPayment";
...
const PaymentSuccess = () => {
  ...
  const handlePaymentSuccess = async () => {
    ...
    const payment = {
      ...
      installment:
        paymentResponse?.card_info !== undefined
          ? paymentData?.card_info?.install_month
          : null,
      card:
        paymentResponse?.card_info !== undefined
          ? paymentData?.card_info?.kakaopay_purchase_corp
          : null,
    };
