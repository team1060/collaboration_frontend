...
import { getProductList, deleteProduct ,getBrand} from '../../../core/util/http/admin/ProductService';
...
const AdminProductList = () => {
 ...
 // 필터링된 데이터
  const filteredProducts = products.filter(product => {
    const productValue = product[filterCategory] ? product[filterCategory].toString() : '';
