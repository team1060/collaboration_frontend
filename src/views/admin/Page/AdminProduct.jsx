...
const AdminProduct = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (product_no) {
        // 제품 수정 로직
        await updateProduct(product_no, formData);
      } else {
        // 제품 등록 로직
  ...
  return (
    <Box
      className="AdminGlobal AdminProduct"
      display="flex"
      ...
      <Box width="48%">
        <FormControl className="formControl" fullWidth>
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={productData.is_shop_pickup}
                onChange={handleChange}
                name="is_shop_pickup"
              />
            }
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={productData.is_shop_delivery}
                onChange={handleChange}
                name="is_shop_delivery"
              />
            }
            label="매장 배송 가능"
          />
