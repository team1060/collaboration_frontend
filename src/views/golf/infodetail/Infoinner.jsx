...
import { getGolfInfo } from "../../../core/util/http/golf/apiGolf";
    ...
    <div id="infoInner">
      <Container>
        ...
        <Grid container className="golfSec1">
          ...
          <Grid container direction="column" item md={6} className="golfCont">
            <div className="tit">{golfInfo?.name}</div>
            <p className="">{golfInfo?.description}</p>
          </Grid>
        </Grid>
        <Grid>
          <div className="reserve">
            <a href="/reservation/detail">
              <Button className="reserveButton" variant="contained">
                예약하기
              </Button>
            </a>
          </div>
          ...
          <Grid item md={5} xs={12} className="Sec2Inner">
            ...
            <Grid container className="golfSec2Inner">
              ...
              <Grid item xs={4} container direction="column" className="tpars">
                ...
                <div>
                  {golfInfo?.land_area?.toLocaleString()}
                  <span>m</span>
                </div>
              </Grid>
            </Grid>
