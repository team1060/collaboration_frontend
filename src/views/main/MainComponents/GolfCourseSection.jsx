    ...
    <div style={{ width: "1200px", margin: "0 auto", marginTop: "15px" }}>
      <div style={{ padding: "15px 15px 10px" }}>
        <Button
          ...
          variant="contained"
          color="primary"
          onClick={() => fetchCoursesByRegion("경기")}
        >
          경기
        </Button>
        <Button
          ...
          variant="contained"
          color="primary"
          onClick={() => fetchCoursesByRegion("충청")}
        >
          충청
        </Button>
        <Button
          variant="contained"
          color="primary"
          onClick={() => fetchCoursesByRegion("경상")}
        >
          경상
        </Button>
      </div>
