...
import { NicknameUpdate, PwUpdate } from "../../../core/util/http/auth/MyPage";
  ...
  return (
    <Container>
      ...
      <form onSubmit={pwChangeHandler}>
        <Grid container className="menu">
          ...
          <Grid item lg={10} md={10} xs={12} className="content">
            ...
            <div className="but" style={{ marginLeft: "30px" }}>
              <Button
                variant="contained"
                type="submit"
                style={{
      ...
      <form onSubmit={nicknameChangHandler}>
        <Grid container className="menu">
          <Grid item lg={2} md={2} xs={3} className="menuinner"></Grid>
