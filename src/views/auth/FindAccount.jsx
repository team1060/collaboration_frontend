...
import { pwSubmit, sendUserData } from "../../core/util/http/auth/Member";
  ...
  const emailHandleSubmit = async (e) => {
    ...
    if (name && phone_number) {
      ...
      try {
        ...
        const sendEmail =
          response.substring(0, 2) + "**" + response.substring(8);
        ...
        <Grid item lg={6} md={6} xs={12}>
          ...
          <div className="inner">
            <Grid container>
              ...
              <Button onClick={handleEmailVerification} variant="contained">
                인증
              </Button>
            </Grid>
          </div>
          ...
          <div className="bgbut">
            <Button variant="contained" type="submit" onClick={pwHandlerSubmit}>
              조회
            </Button>
          </div>
        </Grid>
