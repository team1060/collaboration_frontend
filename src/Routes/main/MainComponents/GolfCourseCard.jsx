  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", marginBottom: "120px" }} className='GolfCourseCard'>
      <Card sx={{
        ...
        <CardContent sx={{ display: 'flex', flexDirection: 'column', flex: '1', justifyContent: 'space-between' }} style={{ position: "relative" }}>
          ...
          <div>
            ...
            <Typography variant="subtitle1" color="text.secondary" paddingBottom="20px" >
              {course.description}
            </Typography>
