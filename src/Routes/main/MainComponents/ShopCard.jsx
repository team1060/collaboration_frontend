...
function formatPrice(price) {
 ...
 const sortedProducts = products
    .map(product => ({ ...product, discount: Math.floor(product.discount * 100) })) // discount 변환
    ...
    <div id='shopCard'>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', maxWidth:"1200px", margin:"0 auto"}} className="shop-card-container">
        {sortedProducts.map((product, index) => (
          <a  href={`/product/view/${product.product_no}`} key={index} style={{ textDecoration: 'none' }}>
            ...
            <CardMedia
             ...
             <CardHeader
              ...
              <CardContent>
                ...
                가 격 : {formatPrice(calculateDiscountedPrice(product.price, product.discount))}원
                </Typography>
              </CardContent>
            </Card>
          </a>
